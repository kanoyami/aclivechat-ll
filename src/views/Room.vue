...
export default {
  ...
  methods: {
    updateConfig() {
      ...
      cfg.exchangeRate = toInt(
        cfg.exchangeRate,
        chatConfig.DEFAULT_CONFIG.exchangeRate
      );
    ...
    onWsMessage(event) {
      ...
      switch (cmd) {
        ...
        case COMMAND_JOIN_ROOM:
          if (
            !this.config.showJoin ||
            this.mergeSimilarOther(data.authorName, this.config.joinText)
          ) {
            break;
          }
          message = {
        ...
        case COMMAND_QUIT_ROOM:
          if (
            !this.config.showQuit ||
            this.mergeSimilarOther(data.authorName, this.config.quitText)
          ) {
            break;
          }
          message = {
        ...
        case COMMAND_ADD_LOVE:
          if (
            !this.config.showLove ||
            this.mergeSimilarOther(data.authorName, this.config.loveText)
          ) {
            break;
          }
          message = {
        ...
        case COMMAND_ADD_FOLLOW:
          if (
            !this.config.showFollow ||
            this.mergeSimilarOther(data.authorName, this.config.followText)
          ) {
            break;
          }
          message = {
